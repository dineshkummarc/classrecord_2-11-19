...
<title><?php echo $title; ?> | St. Nicolas Portal </title>
...
<div class="navbar-fixed-top navbar-TOPsm  col-md-10    col-md-offset-1"    role="navigation">
  <div class="container">
    <div class="navbar-header">
          <h5 class="navbar-menu p" >E-Blending Application</h5>
        ...
        <ul class="navbar-nav p navbar-right tooltip-demo" style="margin-left:-8%;"> 
            <li class="dropdown dropdown-toggle ">
              <a  data-toggle="tooltip" data-placement="left" title="Contact Us"   href="<?php echo web_root.'index.php'  ?>"> 
               <i class="fa fa-phone fa-fw"> </i>  Call Us: (045)961-1177 OR Email Us: stnlcolascollege.edu.ph
              </a>
            </li>
   ...
   <div class="col-md-4">
    <div class="row " style="margin-top: -25px"> 
     <p > 
        ...
        <h1 align="center" > ST.NICOLAS COLLEGE Portal</h1>
        </a>
    </p>
...
?>
            ...
            <footer class="panel-footer" style="background-color:green;color:#fff;" >
              <p align="left" >&copy; St. Nicollas College Web and  Mobile Record Application </p>
           </footer>
      </div>
