   ...
   <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <img src="<?php echo web_root; ?>img/logo2.png" height="23">
                WEB AND MOBILE RECORD APPLICATION</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <?php } ?>
                         <?php if ($_SESSION['ACCOUNT_TYPE']=='Administrator') {  ?>
                        <li>
                             <a href="<?php echo web_root; ?>admin/course/index.php"><i class="fa fa-book fa-fw"></i>Course </a>
           
                        </li> 
                      <?php } ?>
                         
                        <li>
                             <a href="<?php echo web_root; ?>admin/schedule/index.php" ><i class="fa fa-clock-o fa-fw"></i>Class Schedule</a>
                        </li> 
                        
                         <?php if ($_SESSION['ACCOUNT_TYPE']=='Teacher' || $_SESSION['ACCOUNT_TYPE']=='Administrator') {  ?>
                        <li>
                             <a href="<?php echo web_root; ?>admin/class/index.php" ><i class="fa fa-group fa-fw"></i>  Class </a>
