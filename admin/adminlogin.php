   ...
   <div class="container tm-container">
            ...
            <div class="row navbar-row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 navbar-container">
                    ...
                    <a href="javascript:void(0)" class="navbar-brand" id="go-to-top"> ST.NICOLAS COLLEGE </a>
            ...
            <div class="tm-page-content">                
                ...
                <section id="tm-section-3" class="row tm-section">
                    <div class="tm-white-curve-left col-xs-12 col-sm-6 col-md-6 col-lg-7 col-xl-6">
                        ...
                        <div class="tm-white-curve-text">
                            <h2 class="tm-section-header gray-text">About St. Nicolas College</h2>
                            <p class="thin-font">ST. NICOLAS COLLEGE, The paramount role of St. Nicolas College of Business & Technology is to empower the studentry, through proper education and training, with a solid foundation of knowledge, skills and moral values necessary in the attainment of their potentials thereby enabling them to be competative citizens of the our country.</p>    
                        </div>
...
Call Center: (045)961-1177(ST. NICOLAS COLLEGE) </br>
Email: stnlcolascolege.edu.ph </br>
                            ...
                            <div class="contact-info-links-container">
                                ...
                                <span class="green-text contact-info">
								 <h3 class="tm-section-subheader green-text">Office Directory:</h3>
                                	Tel: <a href="tel:0100200340" class="contact-info-link"> Tel: (045)961-1177</a></span>
                                <span class="green-text contact-info">
                                	Email: <a href="mailto:info@company.com" class="contact-info-link">stnlcolascolege.edu.ph </a></span>    
                            </div>
